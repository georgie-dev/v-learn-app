            ...
            <tbody className='mt-10'>
              {select.map((data)=>(
                <tr key={data} className=' border-b p-4 rounded-lg text-slate-900 odd:bg-gray-200 mt-12  odd:dark:bg-slate-500 dark:text-gray-200'>
                  <td className='lg:px-16 p-3 text-xs lg:text-lg font-rokkitt font-semibold'>SEN 102</td>
                  <td className='lg:px-16 p-3 text-xs lg:text-lg font-rokkitt font-semibold'>Bernard Ephraim</td>
                  <td className='lg:px-16 p-3 text-xs lg:text-lg font-rokkitt font-semibold'> 12/02/2023</td>
                  <td className='lg:px-16 p-3 text-xs lg:text-lg font-rokkitt font-semibold flex gap-2'>
                    <button
                    type='button'
